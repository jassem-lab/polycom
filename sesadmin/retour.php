					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page" style="color:black">Gestion des retour & remboursement</li>
							</ol>
						</nav>
					</div>
				</div>
...
<?php
	...
	if(isset($_POST['enregistrer_mail'])){	
		...
		$retour		=	addslashes($_POST["mytextarea"]) ;	

		
		$sql="UPDATE `presentation` SET `retour`='".$retour."' where id=".$id;	
		$req=mysql_query($sql);
...
?>	
				...
				<form action="" method="POST"> 
					<div class="col-md-12 row">
						...
						<hr>
						<div class="col-md-12">
							<b>Retour & remboursement</b><br>
							<textarea id="mytextarea" name="mytextarea"><?php echo $retour; ?></textarea>
						</div>
