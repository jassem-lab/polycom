            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        <li class="breadcrumb-item"><a href="dashbord.php"><i class="bx bx-home-alt"
                                    style="color:#0d7cbc"></i></a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page" style="color:black">Gestion de
                            présentation</li>
                    </ol>
                </nav>
            </div>
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                <div class="col-md-12 row">
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="presentation" id="example"><?php echo $presentation ?></textarea>
                    </div>
                    <script>
