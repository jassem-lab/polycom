					...
					-->
						<li>
							...
							<ul>
								...
								<li> <a href="./gest_contact.php"><i class="bx bx-right-arrow-alt"></i>Gestion des contacts</a></li>
								<li> <a href="./gest_newsletter.php"><i class="bx bx-right-arrow-alt"></i>Gestion des newsletters</a></li>
						...
						<li>
							...
							<ul>
								<li> <a href="./categories.php"><i class="bx bx-right-arrow-alt"></i>Gestion des services</a></li>			
								<li> <a href="./souscategories.php"><i class="bx bx-right-arrow-alt"></i>Gestion des sous services</a></li>	
