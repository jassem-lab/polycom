...
<div class="page-wrapper">
    <div class="page-content">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        <li class="breadcrumb-item" style="color:#0d7cbc;border-color: #8833ff;"><a
                                href="dashbord.php"><i class="bx bx-home-alt" style="color:#0d7cbc"></i></a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page" style="color:black">Gestion des
                            sous-services</li>
                    </ol>
                </nav>
            </div>
        ...
        <?php
		 $query = "select *  from souscategories where categorie ";
	...
	if(isset($_POST['enregistrer_mail'])){	
		...
		if($id==0){	
			...
			echo	$sql="INSERT INTO `souscategories`(`categorie`, `souscategorie`, `logo`, `presentation`) VALUES   ('".$categorie."','".$souscategorie."','".$pathcomplete."','".$presentation."')";
				...
				$sql="INSERT INTO `souscategories`(`categorie`, `souscategorie`, `presentation`) VALUES ('".$categorie."','".$souscategorie."' , '".$presentation."')";
			}
				$req=mysql_query($sql);
		} else{
			$type1=pathinfo(basename($_FILES["image"]["name"]), PATHINFO_EXTENSION);
        ...
        <div class="row">
            <form action="" method="POST" enctype="multipart/form-data">
                <div class="col-md-12 row">
                    ...
                    <font color="green">
                        <center>L'ajout de sous-service a été effectué avec succès !</center>
                    </font><br /><br />
                    <?php } ?>
                    <?php if($_GET['suc']=='succes1'){ ?>
                    <font color="green">
                        <center>La modification a été effectué avec succès !</center>
                    </font><br /><br />
                    <?php } ?>
                    <?php } ?>
                    <hr>
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control" name="souscategorie" id="souscategorie"
                            value="<?php echo $souscategorie;?>" required>
                    </div>
                    <div class="col-md-2">
                        <b>Service</b><br>
                        <select class="single-select" data-placeholder="" name="categorie" required>
                            ...
                            <?php
								...
								?>
                            <option value="<?php echo $enregm['id']; ?>" <?php if($enregm['id']==$categorie){ ?>
                                selected <?php } ?>><?php echo $enregm['categorie']; ?></option>
                            <?php } ?>
                        </select>
                    </div>
                    <div class="col-md-2">
                    ...
                    <div class="col-md-2"><br>
                        <button type="submit" onclick="CreateTodo();" class="btn btn-primary"
            ...
            <form name="SubmitContact" class="" method="post" action="" onSubmit="" style=''>
                ...
                <div class="col-xl-12">
                    <div class="row">
                        ...
                        <div class="col-xl-3">
                            ...
                            <select class="single-select" data-placeholder="" name="idcategorie">
                                ...
                                <?php
											...
											while($enregm=mysql_fetch_array($querym)){
										?>
                                <option value="<?php echo $enregm['id']; ?>" <?php if($enregm['id']==$idcategorie){ ?>
                                    selected <?php } ?>><?php echo $enregm['categorie']; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                        <div class="col-xl-3">
                            <b></b><br>
                            <input name="SubmitContact" type="submit" id="submit" class="btn btn-primary btn-sm "
                                style="background-color:#0d7cbc;border-color: #8833ff;" value="Filtrer">
                        </div>
                    </div>
                </div>
            </form>
...
?>
                            <tr style="border: solid 1px;">
                                ...
                                <td>
                                    <a href="souscategories.php?ID=<?php echo $id; ?>"><i class="bx bxs-edit"
                                            style="color:#0d7cbc"></i></a>
                                    <?php if($num==0){ ?>
                                    <a href="Javascript:Supprimer('<?php echo $id; ?>')"><i class="bx bxs-trash"
                                            style="color:red"></i></a>
                                    <?php } ?>
                                </td>
                            </tr>
