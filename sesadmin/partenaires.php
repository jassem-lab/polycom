...
function Supprimer(id)
	  {
			...
			{
				document.location.href="pages_supp/supprimer_partenaire.php?ID="+id ;
			}			    
	  }	  
</script>	
					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page" style="color:black">Gestion des références</li>
							</ol>
						</nav>
					</div>
				</div>
...
<?php
	...
	if(isset($_POST['enregistrer_mail'])){	
		...
		if($id==0){	
			...
			if($type1=="jpg" or $type1=="JPG" or $type1=="jpeg" or $type1=="JPEG" or $type1=="png" or $type1=="PNG" or $type1=="bmp" or $type1=="BMP" or $type1=="gif" or $type1=="GIF"){
				...
				$sql="INSERT INTO `partenaires`(`image`,`titre`) VALUES ('".$pathcomplete."','".$titre."')";
				$req=mysql_query($sql);
			}
	...
	$image				=	"" ;	
	$titre				=	"" ;
	$req="select * from partenaires where id=".$id;
...
<?php
	$etat	=	"";
	$req1="select * from partenaires order by id";
