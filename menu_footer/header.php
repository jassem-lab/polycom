...
<html>
  ...
  <head>
    ...
    <!-- flaticon -->
    <link
      href="assets/css/flaticon/css/flaticon.css"
      media="screen"
      rel="stylesheet"
      type="text/css"
    />
    ...
    <link
      href="assets/css/easy-sidebar.css"
      media="screen"
      rel="stylesheet"
      type="text/css"
    />
    <!-- prettyPhoto -->
    <link
      href="assets/js/pp/css/prettyPhoto.css"
      media="screen"
      rel="stylesheet"
      type="text/css"
    />
    <!-- isotope -->
    <link
      href="assets/js/vendors/isotope/isotope.css"
      media="screen"
      rel="stylesheet"
      type="text/css"
    />
    <!-- preloader CSS -->
    <link
      href="assets/css/spinkit/spinkit.css"
      media="screen"
      rel="stylesheet"
      type="text/css"
    />
      ...
      <div class="container">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">
            <img  style = "max-width : 120px" alt="logo"  src="<?php echo 'sesadmin/'.$logo ?>"
          /></a>
          <!-- -- -- - -- -- -- - -- -- -- - -- -- -- -- -
                  LOGO END
                  -- -- -- - -- -- -- - -- -- -- - -- -- -- -- -->
              ...
              <ul class="nav navbar-nav navbar-right">
                <!-- -- -- - -- -- -- - -- -- -- - -- -- -- -- -
                  ...
                  <a
                    ...
                    role="button"
                  >
                    Acceuil <span class="x-caret"></span
                  ></a>
                ...
                <?php 
                          ...
                          ></a>
                             ...
                             <li><a href="sousCategorie.php?ID=<?php echo $enreg2['souscategorie']; ?>"><?php echo $enreg2['souscategorie']; ?></a></li>
                             <?php
                          }
                          ?>
                ...
                <li class="header-customize">
                  ...
                  <div class="search-button-wrapper header-customize-item">
                    <a
                      class="icon-search-menu"
                      data-search-type="standard"
                      href="#search"
                    >
