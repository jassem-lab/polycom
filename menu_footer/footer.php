        ...
        <div class="row">
            <div class="col-md-6 col-md-push-3 text-center">
                <div class="footer-logo">
                    <a href="./index.html">
                        <img alt="" src="images/logo-light.png" /></a>
                    <div class="clear"></div>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="footer-widget">
                    ...
                    <div class="footer-newsletter">
                        <p>
                            Entrez votre adresse e-mail pour notre liste de diffusion afin de notre dernière mise à
                            jour.
                        </p>
                        ...
                        <form action="insertNewsletter.php" method="post">
                            ...
                            <div style="margin-top : 10px" class="alert alert-success m-5 pt-5" role="alert">
                                <font color="green">
                                    <center>Merci beaucoup pour votre message. Nous vérifions fréquemment vos e-mails et
                                        ferons de notre mieux pour répondre à votre demande</center>
                                </font><br /><br />
                            </div>
                            <?php } ?>
                            <?php } ?>
...
<a class="back-to-top" href=".top-bar">
    <i aria-hidden="true" class="fa fa-chevron-up"></i></a>
<!-- -- -- - -- -- -- - -- -- -- - -- -- -- -- -
back-to-top end
-- -- -- - -- -- -- - -- -- -- - -- -- -- -- -->
<!-- -- -- - -- -- -- - -- -- -- - -- -- -- -- -
...
<script src="assets/revolution/js/extensions/revolution.extension.carousel.min.js" type="text/javascript"></script>
...
<script src="assets/revolution/js/extensions/revolution.extension.migration.min.js" type="text/javascript"></script>
...
<script src="assets/revolution/js/extensions/revolution.extension.video.min.js" type="text/javascript"></script>
<link href="assets/revolution/css/navigation.css" media="screen" rel="stylesheet" type="text/css" />
<link href="assets/revolution/css/settings.css" media="screen" rel="stylesheet" type="text/css" />
